...
#)
add_library( json_rpc_cpp UNKNOWN IMPORTED )
set_property( TARGET json_rpc_cpp PROPERTY IMPORTED_LOCATION "${JSON_RPC_CPP_COMMON_LIBRARY}" "${JSON_RPC_CPP_SERVER_LIBRARY}" "${JSON_RPC_CPP_CLIENT_LIBRARY}")
set_property( TARGET json_rpc_cpp PROPERTY INTERFACE_INCLUDE_DIRECTORIES "${JSON_RPC_CPP_INCLUDE_DIR}")
