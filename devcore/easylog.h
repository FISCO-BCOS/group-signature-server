...
public:
	...
	void append(unsigned long _t) { m_sstr << std::to_string(_t); }
	void append(long _t) { m_sstr << std::to_string(_t); }
	void append(unsigned int _t) { m_sstr << std::to_string(_t); }
	void append(int _t) { m_sstr << std::to_string(_t); }
	void append(double _t) { m_sstr << std::to_string(_t); }
